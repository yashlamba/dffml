...
ORG = "johnsa1"
NAME = "dffml-operations-encoding"
DESCRIPTION = "DFFML Encoding Operations"
...
setup(
    ...
    entry_points={
        "dffml.operation": [
            f"encode_base64_image = {IMPORT_NAME}.operations:encode_base64_image.op",
        ],
        "dffml.operation.implementation": [
            f"encode_base64_image = {IMPORT_NAME}.operations:encode_base64_image.imp",
        ],
    },
)
